...
| :--- | :--- | :--- | :--- |
| **Infra-Pol-01** | Local Ollama Engine & Llama 3 (8B) | **On-Premise Compute:** Eliminates external data transit. | `assets/02_ollama_service.png` |
| **Infra-Pol-02** | Localhost Port Binding (11434) | **Zero-Trust Network:** Isolates API from external attackers. | `assets/03_api_validation.png` |
| **Infra-Pol-03** | OpenSSH Daemon (`sshd`) | **Remote Access:** Encrypted headless administration. | `assets/01_ssh_connectivity.png` |
